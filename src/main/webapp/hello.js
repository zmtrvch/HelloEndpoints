...
function enableButtons () {
	...
	btn = document.getElementById("input_show_time");
        btn.onclick=function(){showTime();};

        	// Update the button label now that the button is active
        btn.value="Click me for showing time";
...
var request = gapi.client.helloworldendpoints.showTime({'time':time});
request.execute(sayHelloCallback);
}
